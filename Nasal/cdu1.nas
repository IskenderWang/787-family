var cdu = {
	...
	update : func {
		...
		if (page == "IDENT") {
			...
			setprop("/controls/cdu/display/l1", getprop("/sim/description"));
			setprop("/controls/cdu/display/l2", "");
			setprop("/controls/cdu/display/l3", "");
			setprop("/controls/cdu/display/l4", "");
			setprop("/controls/cdu/display/l5", "");
			...
			setprop("/controls/cdu/display/r1", getprop("/sim/engine"));
			...
			if (getprop("/instrumentation/efb/page") == "Airport Charts") {
				...
				if (me.nochart == 1)
					setprop("/controls/cdu/display/l4", "No Available Charts");
				else
					setprop("/controls/cdu/display/l4", getprop("/instrumentation/efb/chart/selected"));
			...
			setprop("/controls/cdu/display/l1", "CRUISE");
			setprop("/controls/cdu/display/r1", "DESCEND");

			setprop("/controls/cdu/display/l2", "Automatic descent:");
			setprop("/controls/cdu/display/r2", getprop("/it-vnav/output/auto-descend"));

			setprop("/controls/cdu/display/l3", "Descent type:");
			setprop("/controls/cdu/display/r3", getprop("/it-vnav/output/descent-type"));

			setprop("/controls/cdu/display/l4", "Phase of flight:");
			setprop("/controls/cdu/display/r4", getprop("/it-vnav/output/controller"));

			setprop("/controls/cdu/display/l5", "Transition controller:");
			setprop("/controls/cdu/display/r5", getprop("/it-vnav/output/steps"));

			setprop("/controls/cdu/display/l6", "Minimums:");
			setprop("/controls/cdu/display/r6", getprop("/instrumentation/mk-viii/inputs/arinc429/decision-height"));
