...
var walk_about = func(wa_distance) {
	...
	if (i == view.indexof("Pilot View") or i == view.indexof("Left Wing View") or i == view.indexof("Right Wing View") or i == view.indexof("Passenger View (Economy Class)") or i == view.indexof("Passenger View (First Class)") or i == view.indexof("Copilot View")) {
